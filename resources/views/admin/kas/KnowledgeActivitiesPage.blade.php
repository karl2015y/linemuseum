...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
  ...
  <div class="w-100 text-right mb-2 md:mb-0">
    <a href="{{route('CreateKnowledgeActivityPage',['museum_id'=>$museum->id])}}">
    ...
    <tr class="bg-white shadow-md">
      ...
      <td class="p-3">
        <div class="flex align-items-center">
          <div class="ml-3">
            <div class="">{{ $ka->name }}</div>
            <div class="text-gray-500">{{ $ka->email }}</div>
          </div>
        </div>
      </td>
      {{-- 建立時間 --}}
      ...
      <td class="p-3">
        <div class="flex align-items-center">
          <div class="ml-3">
            @if ($ka->CreatedStaff == null)
            <div class="">無</div>
            @else
            <div class=""> {{$ka->CreatedStaff->name}}</div>
            <div class="text-gray-500">{{ $ka->CreatedStaff->email }}</div>
            @endif
          </div>
        </div>
      </td>
