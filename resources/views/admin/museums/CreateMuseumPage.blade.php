...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <nav class="col-span-2">
        <ol class="list-reset py-4 pl-2 rounded flex bg-grey-light text-grey">
            ...
            <li class="px-2">/</li>
            <li class="text-gray-400">新增館舍頁</li>
        </ol>
    </nav>
...
<form action="{{route('CreateMuseum')}}" method="post">
    @csrf
    {{-- 館舍名稱 --}}
    ...
    {{-- 館舍電話 --}}
    <div class="relative h-10 input-component mb-5 formInputGroup">
        <input id="phone" name="phone" value="{{ old('phone') }}" type="text" required
            class="h-full w-full border-gray-300 px-2 transition-all border-blue rounded-sm" />
    ...
    {{-- 消費百點送 --}}
    <div class="relative h-10 input-component mb-5 formInputGroup">
        <input id="buy_hundred_get_point" name="buy_hundred_get_point" value="{{ old('buy_hundred_get_point') }}" type="number" required
            class="h-full w-full border-gray-300 px-2 transition-all border-blue rounded-sm" />
    ...
    <div class="relative h-10 input-component mb-5 formInputGroup">
        ...
        <label for="email" class="absolute left-2 transition-all bg-white px-1">
            館舍信箱(帳號) <span class="text-red-500 font-bold">*</span>
        </label>
    </div>
    {{-- 館舍密碼 --}}
    <div class="relative h-10 input-component mb-5 formInputGroup">
        ...
        <label for="password" class="absolute left-2 transition-all bg-white px-1">
            登入密碼 <span class="text-red-500 font-bold">*</span>
        </label>
    </div>
    {{-- 館舍密碼確認 --}}
    <div class="relative h-10 input-component mb-5 formInputGroup">
        <input id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}" type="password" required
            class="h-full w-full border-gray-300 px-2 transition-all border-blue rounded-sm" />
    ...
    <textarea class="hidden" id="textarea_description" name="description">{{ old('description') }}</textarea> <br>
