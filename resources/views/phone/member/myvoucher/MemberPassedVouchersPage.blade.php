...
<div id="toptitle" class="relative text-center  pb-2 pt-12 bg-color-sec">
    ...
    <span class="text-xl font-medium">我的兌換券-已過期</span>
</div>
    ...
    @foreach ($vcrs as $vcr)
        <a href="{{route('MemberVoucherPage', ['voucher_record_id'=>$vcr->id])}}">
            <div class="p-4 border-solid border-t-2 border-gray-300">
                ...
                <div class="mb-1 ml-2 font-light text-sm text-gray-400 text-center">已在 {{$vcr->VoucherRecordStatus->created_at}} 時過期</div>
                <div >
                    <button
