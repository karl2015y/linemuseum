...
@section('title', '修改收件人資料')
@section('content')

{{-- topbar --}}
<div id="toptitle" class="relative text-center  pb-2 pt-12 bg-color-sec">
    <a href="{{route('MemberVoucherPage',$PreVoucherRecord->voucher_record_id)}}">
    ...
    <span class="text-xl font-medium">修改收件人資料</span>
</div>
        ...
        <form action="" method="post">
            ...
            <div>
                ...
                <div>
                    ...
                    <input name="name" required placeholder="請輸入收件人姓名" v-model="name"
                ...
                <div>
                    ...
                    <input name="phone" required placeholder="請輸入收件人手機號碼" v-model="phone"
                        class="mt-2 bg-gray-100 rounded p-1 shadow-inner w-full" type="text">
                </div>
                {{-- 電子信箱 --}}
                <div>
                    <div class="mt-3 text-gray-500"><span class="text-sm text-red-500">* </span>電子信箱</div>
                    <input name="email" required placeholder="請輸入電子信箱" v-model="email"
                ...
                <div>
                    ...
                    <input name="address" required ref="addressInputTxt" placeholder="完整收件地址" v-model="address" name="address"
                        class="mt-2 bg-gray-100 rounded p-1 shadow-inner w-full" type="text">
            ...
            <div>
                {{-- 更新 --}}
                <button
                    class="w-10/12 mx-auto mt-16 py-2 px-6 text-white rounded bg-color-main shadow block md:inline-block">更新</button>
            </div>
        </form>
...
<script>
  ...
  data: {
    ...
    chooseDistrict:null,
    chooseCode:null,
    address:"{{old('address',$PreVoucherRecord->address)}}",
    name:"{{old('name',$PreVoucherRecord->name)}}",
    phone:"{{old('phone',$PreVoucherRecord->phone)}}",
    email:"{{ old('email',$PreVoucherRecord->email) }}",
