...
<form action="{{route('MuseumLogin')}}" method="post" class="px-10">
    @csrf
    ...
    <input value="{{ old('email') }}" name="email" class=" shadow-inner mt-1 mb-10 w-full bg-gray-100 p-2.5 rounded" type="text" placeholder="館舍登記電子信箱">
