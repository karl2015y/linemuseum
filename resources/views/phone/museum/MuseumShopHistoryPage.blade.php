...
<div id="toptitle" class="relative text-center  pb-2 pt-12 bg-color-sec">
    <a href="{{route('MuseumShopDatasPage',['shop_id'=>1])}}">
    ...
    <span class="text-xl font-medium">商家消費紀錄列表</span>
</div>
...
<div class="bg-gray-200 p-2 pb-10 ">
    ...
    <div class="px-4 py-6 bg-white rounded shadow flex  items-center mb-2">
        ...
        <div class="pl-4 text-sm font-light">
            ...
            <div>獲得消費點｜<span class="text-color-third text-xl font-medium">{{$ppr->point}}</span> 點</div>
